...
class RejectTest < Minitest::Test
  ...
  def test_remove_words_with_more_than_three_letters
    ...
    # Your code goes here
    selected = words.reject{|w| w.length > 3}
  ...
  def test_remove_words_ending_in_e
    ...
    # Your code goes here
    selected = words.reject{|w| w.end_with?('e')}
  ...
  def test_remove_words_ending_in_ing
    ...
    # Your code goes here
    selected = words.reject{|w| w.end_with?('ing')}
  ...
  def test_remove_words_containing_e
    ...
    # Your code goes here
    selected = words.reject{|w| w.include?('e')}
  ...
  def test_remove_dinosaurs
    ...
    # Your code goes here
    notasaurus = animals.reject{|a| a.end_with?('saurus')}
  ...
  def test_remove_animals_starting_with_vowels
    ...
    # Your code goes here
    remaining = animals.reject{|a| a.start_with?("a", "e", "i", "o", "u", "y")}
  ...
  def test_remove_capitalized_words
    ...
    # Your code goes here
    remaining = words.reject{|w| w == w.upcase}
