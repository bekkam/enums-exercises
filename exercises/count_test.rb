...
class CountTest < Minitest::Test
  ...
  def test_count_words_that_are_uppercase
    ...
    # Your code goes here
    tally = words.count{|w| w.upcase == w}
    assert_equal 3, tally
  end
  ...
  def test_count_words_ending_in_ing
    ...
    # Your code goes here
    tally = words.count{|w| w.end_with?('ing')}
  ...
  def test_count_round_prices
    ...
    # Your code goes here
    tally = prices.count{|p| p == p.floor }
  ...
  def test_count_four_letter_words
    ...
    # Your code goes here
    tally = words.count{|w| w.length == 4}
